...
import com.google.android.play.services.lib.engine.collision.CollisionDetection;
...
import com.google.android.play.services.lib.engine.services.collada.ColladaLoaderTask;
import com.google.android.play.services.lib.engine.services.stl.STLLoaderTask;
import com.google.android.play.services.lib.engine.services.wavefront.WavefrontLoaderTask;
    ...
    public void onLoadComplete(List<Object3DData> datas) {
        ...
        for (Object3DData data : datas) {
            if (data.getTextureData() == null && data.getTextureFile() != null) {
                ...
                try {
					InputStream stream = ContentUtils.getInputStream(data.getTextureFile());
                    if (stream != null) {
