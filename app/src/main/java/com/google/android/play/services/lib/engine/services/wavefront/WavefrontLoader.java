...
package com.google.android.play.services.lib.engine.services.wavefront;
...
public class WavefrontLoader {
	...
	private static String getParameter(Uri uri, String parameter) {
		try {
			BufferedReader br = new BufferedReader(new InputStreamReader(ContentUtils.getInputStream(uri)));
			String line;
